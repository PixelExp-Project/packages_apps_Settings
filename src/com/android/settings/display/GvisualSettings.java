...
public class GvisualSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.display_settings_gvisual);
    ...
    private void setupNavbarSwitchPref() {
        ...
        if (CustomUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_rose")){
            mnbSwitch.setValue("6");
        } else if (CustomUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_blue")){
            mnbSwitch.setValue("5");
        } else if (CustomUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_purp")){
            mnbSwitch.setValue("4");
        } else if (CustomUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_oprd")){
            mnbSwitch.setValue("3");
        } else if (CustomUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_orcd")){
